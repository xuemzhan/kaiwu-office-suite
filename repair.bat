...
set "STARTMENU_DIR=%APPDATA%\Microsoft\Windows\Start Menu\Programs\����칫�׼�?
if not exist "%STARTMENU_DIR%" mkdir "%STARTMENU_DIR%"

REM дʹ��˵�� URL
> "%STARTMENU_DIR%\ʹ��˵��.url" echo [InternetShortcut]
>> "%STARTMENU_DIR%\ʹ��˵��.url" echo URL=file:///%~dp0docs\02_�û�ʹ���ֲ�.md
...
for %%d in ("00_Inbox" "01_��Ŀ��¼" "02_������? "03_OCRʶ��" "04_ͨ��֪ʶ" "05_ģ���? "99_�鵵") do (
