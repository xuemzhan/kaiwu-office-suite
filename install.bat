...
REM V1.4.1: install ����ʧ�ܼ��� + missing ����
...
set "STARTMENU_DIR=%APPDATA%\Microsoft\Windows\Start Menu\Programs\����������ǰ칫�׼�"
...
if exist "check.bat" (
    powershell -command "$WS = New-Object -ComObject WScript.Shell; $SC = $WS.CreateShortcut('%STARTMENU_DIR%\ϵͳ���.lnk'); $SC.TargetPath = '%~dp0check.bat'; $SC.Save()"
...
if exist "repair.bat" (
    powershell -command "$WS = New-Object -ComObject WScript.Shell; $SC = $WS.CreateShortcut('%STARTMENU_DIR%\ϵͳ�޸�.lnk'); $SC.TargetPath = '%~dp0repair.bat'; $SC.Save()"
...
set "STARTMENU_DIR=%APPDATA%\Microsoft\Windows\Start Menu\Programs\����������ǰ칫�׼�"
if not exist "%STARTMENU_DIR%" mkdir "%STARTMENU_DIR%"
echo # ����������ǰ칫�׼� V1.4.1 > "%STARTMENU_DIR%\ʹ��˵��.url"
echo URL=file:///%~dp0docs\02_�û�ʹ���ֲ�.md >> "%STARTMENU_DIR%\ʹ��˵��.url"
...
echo.
echo Install log: %LOG_FILE%
echo User manual: see docs\02_�û�ʹ���ֲ�.md
echo.
pause
